...
public class ImageServlet extends HttpServlet {
    ...
    public void init() throws ServletException {
        ...
        try {
            prop.load(getClass().getClassLoader().getResourceAsStream("com/store/properties/server.properties"));
        } catch (IOException ex) {
            Logger.getLogger(ImageServlet.class.getName()).log(Level.FINE, null, ex);
        }
        this.imagePath = prop.getProperty("upload_path");
